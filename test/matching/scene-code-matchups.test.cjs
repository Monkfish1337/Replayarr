// Ported from SeriousSportSync (Monkfish1337/Serioussportsync @ 0706d4d), test/scene-code-matchups.test.js.
'use strict';
...
const promotions = require('../../src/matching/promotions.cjs');
