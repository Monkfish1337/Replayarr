// Ported from SeriousSportSync (Monkfish1337/Serioussportsync @ 0706d4d), test/release-filter-language.test.js.
'use strict';
...
const releaseFilter = require('../../src/matching/release-filter.cjs');
