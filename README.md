...
> **Phase 2.** Request → search → download → import runs on its own: quality profiles decide what is grabbed automatically and when an event is upgraded ([docs/phase-2.md](docs/phase-2.md)). Phase 1, the manual loop with Jellyfin metadata, is in [docs/phase-1.md](docs/phase-1.md).
